...
namespace msa_project.Server.Controllers
{
    public class HabitsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Icon,Label,IsCompletedToday,MonthlyCheckIns,TotalCheckIns,Streak,LastCheckInDate,UserId")] Habit habit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Icon,Label,IsCompletedToday,MonthlyCheckIns,TotalCheckIns,Streak,LastCheckInDate,UserId")] Habit habit)
        {
            if (id != habit.Id)
            {
                return NotFound();
